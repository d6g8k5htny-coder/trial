...
echo "=== Batch 82 — PERMANENT window; ALIGNED @ 1c6e74b (PR #41); Path C BASE_TIP ${BASE_TIP_SHORT}; when_writable_land background lander; unrestricted/auto-approve; HOLD VOID ==="
