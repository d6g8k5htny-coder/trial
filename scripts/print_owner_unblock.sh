...
echo "=== Batch 305 — PERMANENT window; Path C BASE_TIP ${BASE_TIP_SHORT}; write ${WRITE_STATE}; tip ${STATUS_TIP}${IDLE_STATUS:+; idle ${IDLE_STATUS}}; unrestricted/auto-approve; HOLD VOID ==="
...
echo "  Batch 305: tip-sync 02cfbfd→077464e after main #85+#89; keep-prior abort fix (bundle verify on trial ROOT under pipefail); REFRESH default 305; _LIVING_TIPS+=077464e"
