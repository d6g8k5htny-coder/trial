...
echo "=== Batch 64 — PERMANENT window; ALIGNED @ 1c6e74b (PR #41); Path C BASE_TIP ${BASE_TIP_SHORT} (post-#43); unrestricted/auto-approve; HOLD VOID ==="
...
echo "$ROOT/scripts/refresh_restore_plan.py --batch 64"
