...
echo " Batch 340: audit_main_alignment 403 rate-limit backoff + raw/ls-remote fallback; CI soft-continue transport exit 2; republish CRITICAL includes audit_main_alignment"
echo " Batch 328: inventory refresh INV_BATCH derives from print_owner header (was frozen 323)"
