...
echo "=== Batch 168 — PERMANENT window; ALIGNED @ 1c6e74b (PR #41); Path C BASE_TIP ${BASE_TIP_SHORT}; owner_path_c_oneshot; unrestricted/auto-approve; HOLD VOID ==="
...
echo "  from-bundle: $ROOT/scripts/owner_path_c_oneshot.sh --from-bundle"
echo "  release: batch168-path-c-bundle (includes oneshot; PATH_C_RELEASE_TAG override ok)"
...
echo "  snapshot: portable/ALIGNED_DRIFT_SNAPSHOT.json  |  release: batch168-path-c-bundle"
echo "Path C ONE-SHOT (owner laptop): gh release download batch168-path-c-bundle -R d6g8k5htny-coder/trial -p 'trial-portable-main-fixes.tgz'"
