...
echo "=== Batch 74 — PERMANENT window; ALIGNED @ 1c6e74b (PR #41); Path C BASE_TIP ${BASE_TIP_SHORT} (PR #48); tip refresh + Batch 73 CI fix; unrestricted/auto-approve; HOLD VOID ==="
...
echo "  snapshot: portable/ALIGNED_DRIFT_SNAPSHOT.json  |  threats: portable/BATCH74_OPEN_PR_THREATS.json"
