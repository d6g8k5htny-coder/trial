...
echo "=== Batch 76 — PERMANENT window; ALIGNED @ 1c6e74b (PR #41); Path C BASE_TIP ${BASE_TIP_SHORT}; path-c-applied-bundle for owner git am; unrestricted/auto-approve; HOLD VOID ==="
...
echo "  snapshot: portable/ALIGNED_DRIFT_SNAPSHOT.json  |  threats: portable/BATCH76_OPEN_PR_THREATS.json"
