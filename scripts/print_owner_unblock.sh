...
echo "=== Batch 58 — MISALIGNED @ c2b0620; unrestricted/auto-approve; HOLD VOID; prefer Path B ==="
echo "Owner: NO restrictions; agents decide. HOLD on PR #2 is VOID."
echo "PR #2 @ b040bf0c was reverted by PR #32; tip now Dylan honest map c2b0620 (still MISALIGNED)."
echo "Path A OR Path B OK. Prefer Path B (Option-B README+AGENTS)."
echo "One-command: $ROOT/scripts/restore_main_face.sh"
...
echo "$ROOT/scripts/refresh_restore_plan.py --batch 58"
