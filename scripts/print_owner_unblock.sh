...
echo " Batch 362: tip_or_eng living script_stale republish + last-resort 361→362 @e3cd7d4"
echo " Batch 362: idle_no_commit tip-stable watch @e3cd7d4 (tip_match; living tip/script current; parent-pin tip lag skipped)"
