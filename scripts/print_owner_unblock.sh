...
echo " Batch 359: tip_or_eng inv tip re-pin + living script_stale republish @e3cd7d4"
echo " Batch 359: eng living script_stale republish after research-audit land (batch241; script_stale 1→0)"
