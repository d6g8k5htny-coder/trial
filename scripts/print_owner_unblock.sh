...
echo " Batch 341: soften Batch 340 tip-sync Intent live BASE_TIP pin (f244312); living tgz republish after tip-sync; grant inventory tip refresh batch 341 (preserve_durable)"
