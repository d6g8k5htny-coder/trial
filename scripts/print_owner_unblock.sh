...
echo "=== Batch 337 — PERMANENT window; Path C BASE_TIP ${BASE_TIP_SHORT}; write ${WRITE_STATE}; tip ${STATUS_TIP}${IDLE_STATUS:+; idle ${IDLE_STATUS}}; unrestricted/auto-approve; HOLD VOID ==="
...
echo " Batch 337: tip-sync eeebb28→848aea2 after main #101/#107/#102 (keep-prior; NOT promoted); REFRESH default 337"
echo " Batch 328: inventory refresh INV_BATCH derives from print_owner header (was frozen 323)"
