...
echo "=== Batch 72 — PERMANENT window; ALIGNED @ 1c6e74b (PR #41); Path C BASE_TIP ${BASE_TIP_SHORT}; aligned_drift_watch ready; unrestricted/auto-approve; HOLD VOID ==="
...
echo "  snapshot: portable/ALIGNED_DRIFT_SNAPSHOT.json  |  threats: portable/BATCH72_OPEN_PR_THREATS.json"
...
echo "Batch 72: BASE_TIP ${BASE_TIP_SHORT} unchanged; write DENIED; no open base=main PRs; drift watch + CI record-only."
echo "pack_portable.sh auto-globs RESTORE_PLAN_* + BATCH*_TOKEN_SEARCH + PATH_C_REBASE_* + BATCH*_RESEARCH_STACK_AUDIT + ALIGNED_DRIFT_SNAPSHOT (Batch 64+/67+/68+/70+/72)."
