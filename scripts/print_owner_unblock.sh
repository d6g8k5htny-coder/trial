...
echo " Batch 359: tip_or_eng conflict-marker cleanup + inv tip re-pin @e3cd7d4"
echo " Batch 359: eng living script_stale republish after inv tip-pin (batch241; script_stale 1→0)"
