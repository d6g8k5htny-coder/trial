...
echo "=== Batch 60 — ALIGNED @ 1c6e74b (PR #41); Path C dry-run @ b3da668; unrestricted/auto-approve; HOLD VOID ==="
echo "Owner: NO restrictions; agents decide. HOLD on PR #2 is VOID."
echo "PR #41 renewed default tip to 1c6e74b (ALIGNED). Window open — keep iterating."
...
echo "$ROOT/scripts/refresh_restore_plan.py --batch 60"
