...
echo " Batch 336: inventory _living_inventory_batch ultimate fallback reads REFRESH_BATCH_TAG (was frozen 331); soften Batch 335 live tip Intent pins; MULTI_AGENT_WAKE"
echo " Batch 328: inventory refresh INV_BATCH derives from print_owner header (was frozen 323)"
