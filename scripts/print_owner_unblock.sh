...
echo " Batch 336: wake poster INTENT tip derives from BASE_TIP (was frozen @077464e); inventory REFRESH_BATCH_TAG fallback; soften 335 live tip pins; MULTI_AGENT_WAKE"
echo " Batch 328: inventory refresh INV_BATCH derives from print_owner header (was frozen 323)"
