...
echo "=== Batch 61 — PERMANENT window; ALIGNED @ 1c6e74b (PR #41); Path C dry-run @ b3da668; unrestricted/auto-approve; HOLD VOID ==="
...
echo "$ROOT/scripts/refresh_restore_plan.py --batch 61"
