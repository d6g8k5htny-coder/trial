...
echo "=== Batch 442 — PERMANENT window; Path C BASE_TIP ${BASE_TIP_SHORT}; write ${WRITE_STATE}; tip ${STATUS_TIP}${IDLE_STATUS:+; idle ${IDLE_STATUS}}; unrestricted/auto-approve; HOLD VOID ==="
echo " Batch 442: tip_or_eng living tgz_newer republish + unfreeze 441→442 @2f7a5a9"
echo " Batch 441: tip_sync_watch living script_stale republish + parent-pin inv @2f7a5a9"
