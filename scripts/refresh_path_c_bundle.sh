...
BATCH_TAG="${REFRESH_BATCH_TAG:-305}"
...
BUNDLE_REQUIRES_SHA=""
if [[ -s "$BUNDLE_OUT" ]]; then
  # Batch 305: verify against WORKDIR (hardening clone), never trial ROOT.
  ...
  # write (BASE_TIP updated, tip-sync incomplete). Same Batch 180 class as the
