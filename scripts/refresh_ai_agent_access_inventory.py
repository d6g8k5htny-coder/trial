...
# Batch 357: last-resort bumped off frozen "356".
    ...
    # Batch 565: last-resort bumped off frozen "564".
    # Batch 566: last-resort bumped off frozen "565".
    # Batch 567: last-resort bumped off frozen "566".
    # Batch 568: last-resort bumped off frozen "567".
    # Batch 569: last-resort bumped off frozen "568".
    # Batch 570: last-resort bumped off frozen "569".
    # Batch 571: last-resort bumped off frozen "570".
    # Batch 572: last-resort bumped off frozen "571".
    # Batch 573: last-resort bumped off frozen "572".
    # Batch 574: last-resort bumped off frozen "573".
    # Batch 575: last-resort bumped off frozen "574".
    # Batch 576: last-resort bumped off frozen "575".
    # Batch 577: last-resort bumped off frozen "576".
    # Batch 578: last-resort bumped off frozen "577".
    # Batch 579: last-resort bumped off frozen "578".
    # Batch 580: last-resort bumped off frozen "579".
    # Batch 581: last-resort bumped off frozen "580".
    # Batch 582: last-resort bumped off frozen "581".
    # Batch 583: last-resort bumped off frozen "582".
    # Batch 584: last-resort bumped off frozen "583".
    # Batch 585: last-resort bumped off frozen "584".
    # Batch 586: last-resort bumped off frozen "585".
    # Batch 587: last-resort bumped off frozen "586".
