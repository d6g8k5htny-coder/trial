...
def _living_inventory_batch(root: str) -> str:
    ...
    Batch 359: last-resort bumped off frozen "358" so empty-tree fallback cannot lag
    living Batch 359 / print_owner header (coordinator WAKE ci_intent_unfreeze_living).
    """
