...
Env:
  ...
  PATH_C_RELEASE_TAG    Prefer this trial release for .bundle link (default: batch202-path-c-bundle)
...
# Batch 202: default release tag batch202-path-c-bundle (tip b89448d refresh; supersedes batch199-path-c-bundle).
PATH_C_RELEASE_TAG="${PATH_C_RELEASE_TAG:-batch202-path-c-bundle}"
