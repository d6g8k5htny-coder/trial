...
> `install_has_main=false` / env repos **trial ONLY**. Device code: `905D-02F4`
> (see `GH_DEVICE_LOGIN.md`). Unblock issue:
> https://github.com/d6g8k5htny-coder/trial/issues/30
> (history: [#27](https://github.com/d6g8k5htny-coder/trial/issues/27) / `BATCH162_BRIEF.json`).
...
> [`RELAUNCH_WITH_MAIN_SCOPE.md`](RELAUNCH_WITH_MAIN_SCOPE.md). Issue #30.
