...
| #27 | Isolate probe tests from tracked receipts | OPEN MERGEABLE/**UNSTABLE** (head `8d023a9`); **already** has inventable/instrumentation receipt isolation (`tmp_path` + snapshot assert) — tip-cut **0005/0006 obsolete after merge**; stack on head = **0001–0004 + 0008** (skip 0005–0007); **no 0009** on tip |
