...
> ## STATUS (Batch 62) — PERMANENT window; ALIGNED @ `1c6e74b`; Path C dry-run @ `b3da668`
>
...
> (rebase onto main **CONFLICTING**). See `portable/RESTORE_PLAN_62.json` + `BATCH62_TOKEN_SEARCH.json`.
