...
On a clone that already has BASE_TIP `542e6ec` (shallow OK — Batch 170 E2E verified `--depth 1` and `--depth 80`):
...
git checkout -B cursor/portable-engineering-patches 542e6ec2f462d6202f5bc5b3a044e71ae7a1a96c
...
```bash
git fetch origin chatgpt/drive-github-hardening-20260919 && git checkout -B cursor/portable-engineering-patches 542e6ec2f462d6202f5bc5b3a044e71ae7a1a96c && git am /path/to/path-c-on-hardening.patch && git push -u origin HEAD
```
