...
```bash
git fetch origin chatgpt/drive-github-hardening-20260919 && git checkout -B cursor/portable-engineering-patches ac335815b277ac0c076082ac6af2344261c2093a && git am /path/to/trial/portable/path-c-applied-bundle/path-c-on-hardening.patch && git push -u origin HEAD
```
...
See `VERIFY.json` for Batch 76 recorded counts.
