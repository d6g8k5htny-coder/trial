...
On a clone that already has BASE_TIP `bfb7c38` (shallow OK — Batch 170 E2E verified `--depth 1` and `--depth 80`):
...
git checkout -B cursor/portable-engineering-patches bfb7c385040b952ca1a3752e4bc7704b383a4167
...
```bash
git fetch origin chatgpt/drive-github-hardening-20260919 && git checkout -B cursor/portable-engineering-patches bfb7c385040b952ca1a3752e4bc7704b383a4167 && git am /path/to/path-c-on-hardening.patch && git push -u origin HEAD
```
