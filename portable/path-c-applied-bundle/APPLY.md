...
On a clone that already has BASE_TIP `62f955a` (shallow OK — Batch 170 E2E verified `--depth 1` and `--depth 80`):
...
git checkout -B cursor/portable-engineering-patches 62f955aa61f608481e48b1fc0d657a1c1ae8e1b5
...
```bash
git fetch origin chatgpt/drive-github-hardening-20260919 && git checkout -B cursor/portable-engineering-patches 62f955aa61f608481e48b1fc0d657a1c1ae8e1b5 && git am /path/to/path-c-on-hardening.patch && git push -u origin HEAD
```
