...
On a clone that already has BASE_TIP `1200501` (shallow OK — Batch 170 E2E verified `--depth 1` and `--depth 80`):
...
git checkout -B cursor/portable-engineering-patches 120050136f5586b9de3c0f054119b978c92f8a49
...
```bash
git fetch origin chatgpt/drive-github-hardening-20260919 && git checkout -B cursor/portable-engineering-patches 120050136f5586b9de3c0f054119b978c92f8a49 && git am /path/to/path-c-on-hardening.patch && git push -u origin HEAD
```
