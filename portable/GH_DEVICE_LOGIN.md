...
| Hardening tip | `377201c` (== BASE_TIP; Path C eng stack ancestor of PR #64 @ `93a4ecd`); path-c-applied-bundle includes **`path-c-on-hardening.bundle`** + `.patch`; release `batch223-path-c-bundle` (prior `batch218-path-c-bundle`)|
