...
| Field | Value |
|-------|-------|
| Started (UTC) | 2026-09-24T14:01:46Z |
| Checked (UTC) | 2026-09-24T14:01:46Z |
| Verification URL | https://github.com/login/device |
| User code | `E577-EEF9` |
| Prior code | `1DAB-B7F7` (Batch 207 renew; seconds_left&lt;90; prior `5160-F839` Batch 202) |
...
| Status | pending (authorization_pending; Batch 207 renew after 1DAB &lt;90s; Batch 194: README link-only — no embedded user code; seconds_left in BATCH207_BRIEF / PATH_C_STATUS) |
| Expires | see `seconds_left` in BATCH207_BRIEF / PATH_C_STATUS (history: BATCH202_BRIEF / BATCH199_BRIEF / BATCH195_BRIEF) |
...
| History briefs | `BATCH207_BRIEF` / `BATCH202_BRIEF` / `BATCH199_BRIEF` / `BATCH195_BRIEF` / `BATCH194_BRIEF` / `BATCH192_BRIEF` / `BATCH190_BRIEF` / `BATCH188_BRIEF` / `BATCH185_BRIEF` / `BATCH183_BRIEF` / `BATCH162_BRIEF` / `BATCH168_BRIEF` / `BATCH169_BRIEF` / `BATCH178_BRIEF` / `BATCH179_BRIEF` / `BATCH180_BRIEF` (issue hygiene create-only) |
