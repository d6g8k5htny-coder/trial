...
| Status | pending (authorization_pending; Batch 227 renew `B4B5-42FE` after `84FB-0605` expired; CI sanity transport retry; install trial-only; sandbox 404; write DENIED; tip `cbaa056`; Path C not landed)|
| Expires | see `seconds_left` in BATCH227_BRIEF / PATH_C_STATUS (history: BATCH226_BRIEF / BATCH224_BRIEF / BATCH223_BRIEF) |
