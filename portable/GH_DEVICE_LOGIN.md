...
| Field | Value |
|-------|-------|
| Started (UTC) | 2026-09-24T11:00:46Z |
| Checked (UTC) | 2026-09-24T11:07:00Z |
| Verification URL | https://github.com/login/device |
| User code | `5E05-EA04` |
| Prior code | `9671-4918` (near-expiry / renewed Batch 176) |
| Prior prior | `7BCB-0057` (Batch 173); older: `EC83-CFC2` (Batch 170); `831C-CB1C` (Batch 169); `905D-02F4` (Batch 168) |
...
| Status | pending (authorization_pending / slow_down; Batch 178 poll; seconds_left in BATCH178_BRIEF) |
| Expires | see `seconds_left` in BATCH178_BRIEF (history: BATCH176_BRIEF / BATCH162_BRIEF) |
