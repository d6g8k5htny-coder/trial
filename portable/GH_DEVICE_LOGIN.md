...
| Checked (UTC) | 2026-09-24T12:57:46Z |
...
| Status | pending (authorization_pending / slow_down; Batch 192 renew after 1C7F &lt;90s; Batch 194: README link-only — no embedded user code; seconds_left in BATCH194_BRIEF / PATH_C_STATUS) |
| Expires | see `seconds_left` in BATCH194_BRIEF / PATH_C_STATUS (history: BATCH192_BRIEF / BATCH190_BRIEF / BATCH188_BRIEF / BATCH185_BRIEF / BATCH183_BRIEF / BATCH180_BRIEF) |
...
| History briefs | `BATCH194_BRIEF` / `BATCH192_BRIEF` / `BATCH190_BRIEF` / `BATCH188_BRIEF` / `BATCH185_BRIEF` / `BATCH183_BRIEF` / `BATCH162_BRIEF` / `BATCH168_BRIEF` / `BATCH169_BRIEF` / `BATCH178_BRIEF` / `BATCH179_BRIEF` / `BATCH180_BRIEF` (issue hygiene create-only) |
