...
- [`portable/patches/`](portable/patches/) — engineering patches 0001–0006 + [`COMPATIBILITY.md`](portable/patches/COMPATIBILITY.md) matrix (BASE_TIP `1547ec4` after PR #20)
