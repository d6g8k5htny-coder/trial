...
- [`portable/patches/`](portable/patches/) — engineering patches 0001–0011 + [`COMPATIBILITY.md`](portable/patches/COMPATIBILITY.md) matrix (BASE_TIP `a8a5dd7` after PR #26)
