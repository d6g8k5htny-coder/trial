...
- [`portable/patches/`](portable/patches/) — engineering patches 0001–0008 + [`COMPATIBILITY.md`](portable/patches/COMPATIBILITY.md) matrix (BASE_TIP `3f85e93` after PR #23)
