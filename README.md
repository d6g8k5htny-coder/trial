...
- [`portable/patches/`](portable/patches/) — engineering patches 0001–0009 + [`COMPATIBILITY.md`](portable/patches/COMPATIBILITY.md) matrix (BASE_TIP `b02efe2` after PR #25)
