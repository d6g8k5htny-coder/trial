...
- [`portable/patches/`](portable/patches/) — engineering patches 0001–0008 + [`COMPATIBILITY.md`](portable/patches/COMPATIBILITY.md) matrix (BASE_TIP `a89f9a7` after PR #22)
