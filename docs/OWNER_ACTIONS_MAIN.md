...
Hardening tip **stable** @ `e3cd7d4`. Eng: inventory trial tip lagged after Batch 358 lands — preserve_durable re-pin→HEAD; REFRESH/last-resort 358→359. `lemma_closed=false`. Goal OPEN. action=`inventory_tip_repin_after_land_head`.
