...
Hardening tip **stable** @ `2f7a5a9`. tip_or_eng: living script_stale after Batch440 research; republish batch241; unfreeze 441→442; inv parent-pin. `lemma_closed=false`. Goal OPEN.
