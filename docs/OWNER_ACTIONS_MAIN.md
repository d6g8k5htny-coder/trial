...
Hardening tip **stable** @ `2f7a5a9`. tip_or_eng idle_no_commit after Batch395 idle+unfreeze; living current; inv parent-pin. Hunt negative. `lemma_closed=false`. Goal OPEN.
