...
Hardening tip **BASE keep-prior** @ `2f7a5a9` (live TIP_DRIFT). tip_sync_watch Soft Intent preserve n=1 (header@539); keep_prior; living current; action=`keep_prior`; inv parent-pin. `lemma_closed=false`. Goal OPEN.
