...
Hardening tip **stable** @ `2f7a5a9`. tip_or_eng: living script_stale after Batch424 tip_sync idle; republish batch241; unfreeze 424→425; inv parent-pin. `lemma_closed=false`. Goal OPEN.
