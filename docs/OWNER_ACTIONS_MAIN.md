...
Hardening tip **stable** @ `2f7a5a9`. tip_or_eng: living tgz_newer after Batch420 idle; republish batch241; unfreeze 420→421; inv parent-pin. `lemma_closed=false`. Goal OPEN.
