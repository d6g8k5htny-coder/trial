...
Hardening tip **stable** @ `2f7a5a9`. tip_or_eng: living script_stale after Batch437 research; republish batch241; unfreeze 438→439; inv parent-pin. `lemma_closed=false`. Goal OPEN.
