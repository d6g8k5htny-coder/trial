...
Hardening tip **stable** @ `2f7a5a9`. tip_or_eng: hunt-negative (living current; inv parent-pin); unfreeze 434→435. Evidence: `portable/BATCH435_TIP_ENG_IDLE.json`. `lemma_closed=false`. Goal OPEN.
