...
- Hunt living negative after tip_sync500 Soft Intent header restore; unfreeze VERIFY lag; inv parent_pin. Inventable skipped. Soft Intent only (441/445 uploaded=false; no harden). action=`idle_no_commit`. Goal OPEN.
