...
### Batch 395 — tip_or_eng idle_no_commit hunt-negative @2f7a5a9 (2026-09-26)

- Tip stable tip_match=1 @ `2f7a5a9`; Path C IDLE@0019; durable 8/8; living tip/script current; inv parent_pin; VERIFY/last-resort 395; `lemma_closed=false`.
- Hunt negative after Batch395 idle+unfreeze peer. Inventable skipped. action=`idle_no_commit`. Goal OPEN.
