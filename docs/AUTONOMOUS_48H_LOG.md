...
- Hunt living negative (tar-noise only) after tip_sync571/research571 Soft Intent preserve; Soft Intent single === header →572; inv parent_pin. Inventable skipped. action=`idle_no_commit`. Goal OPEN.
