...
- Dual-vector `--check` → `durable_token_source=none` → skip App-corrupt; preserve_durable tip refresh trial→`40d6f27` (living HEAD); INV_BATCH→346; coverage 8/8_WRITABLE.
